...
async def predict(
    ...
    try:
        ...
        return templates.TemplateResponse("prediction.html", {"request": request, "prediction_text": f"Prediction: {predicted_label}"})
    except IndexError:
        return templates.TemplateResponse("prediction.html", {"request": request, "prediction_text": "Error in prediction"})
